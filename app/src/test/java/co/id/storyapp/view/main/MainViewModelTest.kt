...
import co.id.storyapp.view.utils.DataDummy
import co.id.storyapp.view.utils.MainDispatchRule
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        val dummyStories = DataDummy.generateDummyUserModel()
        val data: PagingData<ListStoryItem> = ListStoryPagingSource.snapshot(dummyStories)
    ...
    fun `when Get Story Empty Should Return No Data`() = runTest {
        ...
        Mockito.`when`(userRepository.stories()).thenReturn(expectedQuote)
        val mainViewModel = MainViewModel(userRepository)
